...
extern "C" void Java_com_example_nabeo_calender_AsyncTaskTrain_jniSvmTrain(JNIEnv *env, jobject obj, jstring cmdIn){
...
extern "C" void Java_com_example_nabeo_calender_AsyncTaskPredict_jniSvmPredict(JNIEnv *env, jobject obj, jstring cmdIn){
	const char *cmd = env->GetStringUTFChars(cmdIn, 0);
...
// helper function to be called in Java for making svm-predict
extern "C" void Java_com_example_nabeo_calender_AsyncTaskPredict2_jniSvmPredict(JNIEnv *env, jobject obj, jstring cmdIn){
	const char *cmd = env->GetStringUTFChars(cmdIn, 0);
	debug("jniSvmPredict cmd = %s", cmd);
...
extern "C" void Java_com_example_nabeo_calender_CheckAttendance_jniSvmPredict(JNIEnv *env, jobject obj, jstring cmdIn){
	const char *cmd = env->GetStringUTFChars(cmdIn, 0);
	debug("jniSvmPredict cmd = %s", cmd);
...
*/
extern "C" JNIEXPORT int JNICALL Java_com_example_nabeo_calender_Calender_testInt(JNIEnv * env, jobject obj){
	return 5566;
}

extern "C" void Java_com_example_nabeo_calender_Calender_testLog(JNIEnv *env, jobject obj, jstring logThis){
